...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        key: 'handleChange',
	        value: function handleChange(chosen) {
	        ...
	        key: 'simpleOption',
	        value: function simpleOption() {
	            this.setState({ option: arrayOptions });
	        }
	    }, {
	        key: 'objectOption',
	        value: function objectOption() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { style: { paddingTop: (window.innerHeight - 525) / 2 } },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn', onClick: this.selectTywin.bind(this) },
	                            'select Tywin'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn', onClick: this.setDisable.bind(this) },
	                            this.state.disabled ? 'enable' : 'set disabled'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn', onClick: this.simpleOption.bind(this) },
	                            'simple option'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn', onClick: this.objectOption.bind(this) },
	                            'object option'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Relect = (function (_React$Component) {
	    _inherits(Relect, _React$Component);

	    function Relect(props) {
	        _classCallCheck(this, Relect);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Relect).call(this, props));
	        ...
	        _this.moveFocusedOption = _this.moveFocusedOption.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Relect, [{
	        ...
	        value: function componentDidMount() {
	            this.menuDOM = _reactDom2.default.findDOMNode(this.refs.menu);
	        }
	    }, {
	        key: 'toggleMenu',
	        ...
	        value: function moveFocusedOption(move) {
	        ...
	        key: 'focusOption',
	        value: function focusOption(focused) {
	            ...
	            var length = this.props.options.length;
	            if (length > 8) {
	                var height = this.props.optionHeight;
	                var current = this.menuDOM.scrollTop;
	...
	var Menu = (function (_React$Component) {
	    ...
	    _createClass(Menu, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'ul',
	                { className: 'relect-option thin-scroll', style: style },
	                options
	            );
	        }
	    }]);
